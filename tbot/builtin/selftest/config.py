...
"""
        ...
        cfg = parse_config([tempdir / "c1.py", tempdir / "c2.py"])
        assert cfg["foo"] == 2
...
"""
        ...
        cfg = parse_config([tempdir / "c3.py", tempdir / "c4.py"])
...
"""
        ...
        fail = False
        try:
            cfg = parse_config([tempdir / "c3.py", tempdir / "c5.py"])
        ...
        fail = False
        try:
            cfg = parse_config([tempdir / "c5.py", tempdir / "c3.py"])
        except tbot.config.ConfigAssignException:
            fail = True
        assert fail is True
...
"""
        ...
        cfg = parse_config([tempdir / "c5.py", tempdir / "c6.py"])
